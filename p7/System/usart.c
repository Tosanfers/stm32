...
u8 USART_RX_STA[22] = { 0 };    //接收状态标记	，字节数：1+3+16+2  
u8 Num = 0;              //接收数据的当前位置
...
///////////////////////////数字量数值///////////////////////////////	
	while(1)
  {
		...
		{
			Num = 0;
			if(USART_RX_STA[0x02] == 0x02)  //判断帧尾0x02,否者不赋值
			{
...
///////////////////////////模拟量数值///////////////////////////////	
  ...
  {		
		...
		{
			Num = 0;
			if(USART_RX_STA[0x11] == 0x11)  //判断帧尾0x11,否者不赋值
			{
				for(i=0;i<ADC_N;i++)
				{
...
///////////////////////////全部数值///////////////////////////////	
  ...
  {		
		...
		{
			Num = 0;
			if(USART_RX_STA[0x15] == 0x15)  //判断帧尾0x15,否者不赋值
			{
				*Data = USART_RX_STA[1];			//数字量赋值	  
